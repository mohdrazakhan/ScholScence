-- ==============================================================================
-- Migration: School Onboarding Engine (14 & 15 argument overloads)
-- Description: Ensures public.onboard_school_tenant is callable with or without p_per_student_fee
-- ==============================================================================

-- 1. Full 15-argument function (includes p_per_student_fee)
...
-- Grant execution permissions on both overloads
